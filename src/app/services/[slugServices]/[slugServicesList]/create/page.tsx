...
const CreateServiceType = () => { 
  ...
  return (
    <DefaultLayout>
      ...
      <Breadcrumb route="services" pageName="Manage Services" routeSecond={`services/${slugServices}`} pageNameSecond={`/ ${formattedTitle}`} routeThird={`services/${slugServices}/${slugServicesList}`} pageNameThird={`/ ${formattedTitleList}`} routeFour="" pageNameFour="/ Create" routeFive="" pageNameFive="" />      </div>
