  ...
  return (
    <DefaultLayout>
        <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <Breadcrumb route="services" pageName="Manage Services" pageNameSecond="/ Manage Services List" pageNameThird="/ Type" pageNameFour="" pageNameFive="" />
            <ButtonDefault
                    label="Add New Type List Services"
                    link={`/services/list/${id}/${typeId}/create`}
