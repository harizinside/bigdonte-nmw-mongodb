...
const CreatePatient = () => {
    ...
    const serviceId = Array.isArray(typeId) ? typeId[0] : typeId;
    ...
    const handleImageChangeSecond = (e: React.ChangeEvent<HTMLInputElement>) => {
      ...
      const handleSubmit = async (e: React.FormEvent) => {
        e.preventDefault();
        if (!name || !description || !image || !imageSecond) {
        ...
        formData.append("subtos_id", serviceId);
        ...
        try {
          const response = await fetch("/api/services/servicesFourPost", {
            method: "POST",
            body: formData,
          });
  ...
  return (
    <DefaultLayout>
      ...
      <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <Breadcrumb route="services" pageName="Manage Services" pageNameSecond="/ Manage List Services" pageNameThird="/ Type" pageNameFour="/ Patient" pageNameFive="/ Create"/>
        </div>
            ...
            <form onSubmit={handleSubmit} encType="multipart/form-data">
              <div className="p-6.5 ">
                ...
                <div className="mb-7 flex flex-col gap-4.5 xl:flex-col">
                  <div className="">
                    <label className="mb-3 block text-body-sm font-medium text-dark dark:text-white">Patient Description <span className="text-red">*</span></label>
