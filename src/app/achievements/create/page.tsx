...
//           <Breadcrumb route="achievements" pageName="Manage Achievements" pageNameSecond="/ Create" pageNameThird="" pageNameFour="" pageNameFive=""/>
//         </div>
...
const CreateAchievment = () => { 
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (response.status === 201) {
        ...
        setMessage("Gagal menambahkan achievement.");
      }
    } catch (error) {
      setMessage("Error creating Achievement: " + error);
      setIsOpen(true);
  ...
  return (
    <DefaultLayout>
        <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <Breadcrumb route="achievements" pageName="Manage Achievements" routeSecond="" pageNameSecond="/ Create" routeThird="" pageNameThird="" routeFour="" pageNameFour="" routeFive="" pageNameFive=""/>
        </div>
