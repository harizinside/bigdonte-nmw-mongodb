  ...
  return (
    <DefaultLayout>
        <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <Breadcrumb route="dashboard/catalogs" pageName="Manage Catalogs" routeSecond="" pageNameSecond="" routeThird="" pageNameThird="" routeFour="" pageNameFour="" routeFive="" pageNameFive=""/>
            <div className="flex gap-3">
              <ButtonDefault
                      label="Edit Catalog Page"
                      link="/dashboard/catalogs/catalogsPage"
              ...
              <ButtonDefault
                      label="Add New Catalogs"
                      link="/dashboard/catalogs/create"
