  ...
  return (
    <DefaultLayout>
      <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <Breadcrumb route="dashboard/catalogs" pageName="Manage Catalogs" routeSecond={`dashboard/catalogs/edit/${catalog?._id}`} pageNameSecond="/ Edit" routeThird={`dashboard/catalogs/edit/${catalog?._id}`} pageNameThird={`/ ${catalog?.title}`} routeFour="" pageNameFour="" routeFive="" pageNameFive="" />
      </div>
      <div className="grid grid-cols-1 gap-9 sm:grid-cols-1">
        <div className="flex flex-col gap-9"> 
          <div className="rounded-[10px] border border-stroke bg-white shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card">
            <div className="border-b border-stroke px-6.5 py-4 dark:border-dark-3">
              <h3 className="font-semibold text-dark dark:text-white">Edit Catalog</h3>
            </div>
              ...
              <div className="p-6.5">
                <div className="mb-7 flex flex-col gap-4.5 xl:flex-row">
                  <div className="w-full xl:w-full">
                      ...
                      <div
                        id="FileUpload"
                        className="relative mb-1 block w-full h-65 cursor-pointer appearance-none rounded-xl border border-dashed border-gray-4 bg-gray-2 px-4 py-4 hover:border-orange-500 dark:border-dark-3 dark:bg-dark-2 dark:hover:border-orange-400 sm:py-7.5"
                        >
                        <input
                            type="file"
                        ...
                        />
                          <div className="flex flex-col items-center justify-center">
                              ...
                              <Image
                                  width={800}
                                  height={800}
                                  src={(previewImage || catalog?.image) as string}
                                  alt="Preview"
                                  priority
                ...
                <div className="mb-7 flex flex-col gap-4.5 xl:flex-row">
                    <div className="w-full xl:w-1/3">
                        <label className="mb-3 block text-body-sm font-medium text-dark dark:text-white">Catalog Title</label>
                        <input
                            type="text"
                    ...
                    <div className="w-full xl:w-1/3">
                        <label className="mb-3 block text-body-sm font-medium text-dark dark:text-white">Document (PDF)</label>
                        <input
                            type="file"
                            accept="image/*"
