...
const CreateFaqs = () => { 
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setMessage("Error creating faq: " + error);
      setIsOpen(true);
    } finally {
      setLoading(false);
    }
  ...
  return (
    <DefaultLayout>
        <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <Breadcrumb route="dashboard/faqs" pageName="Manage FaQs" routeSecond="dashboard/faqs/create" pageNameSecond="/ Create" routeThird="" pageNameThird="" routeFour="" pageNameFour="" routeFive="" pageNameFive=""/>
        </div>
