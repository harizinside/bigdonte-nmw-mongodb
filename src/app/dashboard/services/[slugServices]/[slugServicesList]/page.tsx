  ...
  return (
    <DefaultLayout>
        <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <Breadcrumb route="services" pageName="Manage Services" routeSecond={`services/${slugServices}`} pageNameSecond={`/ ${formattedTitle}`} routeThird={`services/${slugServices}/${slugServicesList}`} pageNameThird={`/ ${formattedTitleList}`} routeFour="" pageNameFour="" routeFive="" pageNameFive="" />
            <ButtonDefault
                    label="Add New Type List Services"
                    link={`/services/${slugServices}/${slugServicesList}/create`}
