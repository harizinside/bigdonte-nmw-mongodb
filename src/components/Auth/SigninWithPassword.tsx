...
//             name="email"
//             className="w-full rounded-lg border border-stroke bg-transparent py-[15px] pl-6 pr-11 font-medium text-dark outline-none focus:border-orange-400 focus-visible:shadow-none dark:border-dark-3 dark:bg-dark-2 dark:text-white dark:focus:border-orange-400"
//           />
...
//           />
//           <span
//             className={`mr-2.5 inline-flex h-5.5 w-5.5 items-center justify-center rounded-md border border-stroke bg-white text-white text-opacity-0 peer-checked:border-orange-400 peer-checked:bg-orange-400 peer-checked:text-opacity-100 dark:border-stroke-dark dark:bg-white/5 ${
//               data.remember ? "bg-orange-400" : ""
//             }`}
//           >
//             <svg
//               width="10"
...
//         <button
//           type="submit"
//           className="flex w-full cursor-pointer items-center justify-center gap-2 rounded-lg bg-orange-400 p-4 font-medium text-white transition hover:bg-opacity-90"
//         >
//           Sign In
//         </button>
//       </div>
...
export default function SigninWithPassword() {
  const [email, setEmail] = useState(""); // default kosong
  const [password, setPassword] = useState(""); // default kosong
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        if (data.token) {
          setToken(data.token, 3600); // 3600 detik = 1 jam
        }
    ...
    <form onSubmit={handleSubmit}>
      ...
      <div className="mb-4.5">
        <button
          type="submit"
          disabled={loading}
          className="flex w-full cursor-pointer items-center justify-center gap-2 rounded-lg bg-orange-400 p-4 font-medium text-white transition hover:bg-opacity-90 disabled:opacity-70"
        >
