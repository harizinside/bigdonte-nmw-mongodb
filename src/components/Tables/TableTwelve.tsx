...
const packageData: Services[] = [
  {
    number:1,
    name: "Plastic Surgery",
    description: "NMW Plastic Surgery hadir sebagai bagian dari NMW Aesthetic Clinic...	",
              ...
              <tr key={index}>
                ...
                >
                  <div className="flex items-center justify-end space-x-3.5">
                    ...
                    <button className="hover:text-orange-400">
                      <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" strokeLinecap="round" stroke-linejoin="round" stroke-width="1.5"><path d="M15 12a3 3 0 1 1-6 0a3 3 0 0 1 6 0"/><path d="M2 12c1.6-4.097 5.336-7 10-7s8.4 2.903 10 7c-1.6 4.097-5.336 7-10 7s-8.4-2.903-10-7"/></g></svg>
                    </button>
                    <button className="hover:text-orange-400">
                      <svg
