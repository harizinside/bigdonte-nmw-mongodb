        ...
        <table className="w-full table-auto">
          <thead>
            <tr className="bg-[#F7F9FC] text-left dark:bg-dark-2">
              ...
              <th className="min-w-[320px] px-4 py-4 font-medium text-dark dark:text-white xl:pl-7.5">
                Image
              </th>
              ...
              <tr key={index}>
                  <td
                    className={`border-[#eee] px-4 text-center py-4 dark:border-dark-3 w-0 xl:pl-9 ${
                      index === promos.length - 1 ? "border-b-0" : "border-b"
                    }`}
                  >
                ...
                <td
                  className={`border-[#eee] px-4 py-4 dark:border-dark-3 w-170 xl:pl-0 ${index === promos.length - 1 ? "border-b-0" : "border-b"}`}
                >
                  <h5 className="text-dark dark:text-white">
                    {promo.title || "Promo Use Custom Link"}
                  </h5>
                ...
                >
                  <div className="flex items-center justify-end space-x-3.5">
                      <Link href={`/dashboard/promo/edit/${promo._id}`} className="p-0 m-0 flex items-center justify-center">
                    ...
                    <button className="hover:text-red-600" onClick={() => { setSelectedPromo(promo); setIsOpen(true); }}>
                      <svg
          ...
          <div className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-35 z-999 flex justify-center items-center z-50">
            <div className="bg-white rounded-2xl p-6 py-9 w-1/3 shadow-lg">
              ...
              <p className="text-gray-600 my-5 mb-9 text-center text-2xl font-medium">
                Are you sure you want to delete <strong>{selectedPromo.title}</strong>?
              </p>
