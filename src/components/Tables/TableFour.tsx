...
const TableFour = () => {
  ...
  const [selectedBranches, setSelectedBranches] = useState<Branch | null>(null);
              ...
              <tr key={index}>
                ...
                >
                  <div className="flex items-center justify-end space-x-3.5">
                      <Link href={`/dashboard/branches/edit/${branch._id}`} className="p-0 m-0 flex items-center justify-center">
                    ...
                    <button className="hover:text-red-600" onClick={() => { setSelectedBranches(branch); setIsOpen(true); }}>
                      <svg
          ...
          <div className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-35 z-999 flex justify-center items-center z-50">
            <div className="bg-white rounded-2xl p-6 py-9 w-1/3 shadow-lg">
              ...
              <p className="text-gray-600 my-5 mb-9 text-center text-2xl font-medium">
                Are you sure you want to delete <strong>{selectedBranches.name}</strong>?
              </p>
