...
const TableTwelve = () => {
  ...
  const [selectedServices, setSelectedServices] = useState<ServicesList | null>(null);
  ...
  const fetchServices = useCallback(async (page: number) => {
      try {
        ...
        setServices(result.servicesList);
              ...
              <tr key={index}>
                ...
                >
                  <div className="flex items-center justify-end space-x-3.5">
                    <Link href={`/dashboard/services/${slugServices}/edit/${service.slug}`} className="p-0 m-0 flex items-center justify-center">
                    ...
                    <Link href={`/dashboard/services/${slugServices}/${service.slug}`} className="p-0 m-0 flex items-center justify-center">
                      <button className="hover:text-orange-400">
                        <svg
