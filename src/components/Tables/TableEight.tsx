...
const packageData: Faqs[] = [
  {
    number:1,
    question: "Apa itu NMW Aesthetic Clinic?",
    answer: "NMW Aesthetic Clinic adalah klinik kecantikan terpercaya yang menawarkan berbagai layanan perawatan kulit, wajah, dan tubuh. Kami menggunakan teknologi terbaru dan ditangani oleh tim dokter profesional untuk memberikan hasil terbaik bagi Anda."
  },
  {
    number:2,
    question: "Apa itu NMW Aesthetic Clinic?",
          ...
          <tbody>
            {packageData.map((packageItem, index) => (
              <tr key={index}>
                ...
                <td
                  className={`border-[#eee] px-4 py-4 dark:border-dark-3 w-full xl:w-1/2 xl:pl-4 ${index === packageData.length - 1 ? "border-b-0" : "border-b"}`}
                >
                  <h5 className="text-dark dark:text-white">
                    {packageItem.question}
                  </h5>
                </td>
                <td
                  className={`border-[#eee] px-4 py-4 dark:border-dark-3 xl:w-1/2 ${index === packageData.length - 1 ? "border-b-0" : "border-b"}`}
                >
                  <p className="text-dark dark:text-white truncate h-10 w-100">
                    {packageItem.answer}
                  </p>
                </td>
                <td
