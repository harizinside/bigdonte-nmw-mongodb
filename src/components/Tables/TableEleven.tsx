...
const packageData: Articles[] = [
  {
    number:1,
    title: "Keajaiban Botox: Solusi Tepat untuk Wajah Awet Muda	",
    content: "lorem ipsum dolor sit amet",
    image: "/images/articles/articles_image.webp",
    date: "22-03-2024",
  },
  {
    number:2,
          ...
          <tbody>
            {packageData.map((packageItem, index) => (
              <tr key={index}>
                ...
                <td
                  className={`border-[#eee] px-4 py-4 dark:border-dark-3 w-170 xl:pl-0 ${index === packageData.length - 1 ? "border-b-0" : "border-b"}`}
                >
                ...
                >
                  <div className="flex items-center justify-end space-x-3.5">
                    ...
                    <button className="text-red hover:text-orange-400">
                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" stroke-linecap="round" d="M12 21a9 9 0 1 1 0-18a9 9 0 0 1 0 18zM9 9l6 6m0-6l-6 6"/></svg>
                    </button>
                    <button className="hover:text-orange-400">
                      <svg
