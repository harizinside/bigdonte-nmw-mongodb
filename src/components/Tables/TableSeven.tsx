        ...
        <table className="w-full table-auto">
          ...
          <tbody>
            {packageData.map((packageItem, index) => (
              <tr key={index}>
                <td className={`border-[#eee] px-4 text-center py-4 dark:border-dark-3 w-20 xl:pl-7.5 ${index === packageData.length - 1 ? "border-b-0" : "border-b"}`}>
                  <div className="w-0">
                    {packageItem.number}
                  </div>
                </td>
